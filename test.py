...
def task_5fold(fold):
    ...
    test_target = test_df.loc[:,'FLAG']
    '''Boost-pruning'''
    boost_pruning = boost_modify.AdaBoostClassifier(learning_rate=0.5,n_estimators=450,
                                       base_estimator=tree_prune.DecisionTreeClassifier(max_depth=15),algorithm='SAMME')
