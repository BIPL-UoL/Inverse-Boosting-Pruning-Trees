...
class BaseDecisionTree(six.with_metaclass(ABCMeta, BaseEstimator, _LearntSelectorMixin)):
    ...
    def __init__(self,
        ...
        self.prune_feature_importances_ = None
    ...
    def predict(self, X,check_input=True):
        ...
        # Regression
            ...
            if self.n_outputs_ == 1:
                ...
                return proba[:, :, 0]
    def update_feature_importances_(self,feature_importance):
        self.prune_feature_importances_ = feature_importance
    @property
    def feature_importances_(self):
        ...
        if self.prune_feature_importances_!=None:
            return self.prune_feature_importances_
        else:
...
def prune_path_multiprocess(clf, X, y, max_n_leaves=10, n_iterations=10,
    ...
    leaves = np.arange(int(min_leaf_num*0.9),int(min_leaf_num*0.15),-4)
